...
class MobileReservasConsumerPactTest {
    ...
    V4Pact listarReservas(PactDslWithProvider builder) {
        ...
        return builder
                ...
                .uponReceiving("Mobile consulta el listado de reservas")
    ...
    V4Pact buscarReservaPorId(PactDslWithProvider builder) {
        ...
        return builder
                ...
                .uponReceiving("Mobile consulta una reserva por id")
    ...
    V4Pact cancelarReservaProtegida(PactDslWithProvider builder) {
        ...
        return builder.given("existe una reserva programada cancelable")
                .uponReceiving("Mobile cancela una reserva protegida")
    ...
    V4Pact proponerAlternativaProtegida(PactDslWithProvider builder) {
        ...
        return builder.given("existe una solicitud en revision del piso administrado")
                .uponReceiving("Mobile propone un horario alternativo")
    ...
    void mobileListaReservasConEstructuraPaginada(MockServer mockServer) throws Exception {
    ...
    void mobileObtieneReservaPorId(MockServer mockServer) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    void mobileCancelaReservaConBearer(MockServer mockServer) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    void mobileProponeAlternativa(MockServer mockServer) throws Exception {
        HttpRequest request = HttpRequest.newBuilder()
