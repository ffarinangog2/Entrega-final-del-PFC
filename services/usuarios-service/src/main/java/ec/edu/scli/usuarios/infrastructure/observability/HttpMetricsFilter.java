package ec.edu.scli.usuarios.infrastructure.observability;
 ...
 * petición procesada por usuarios-service, etiquetada por ruta, método
 * HTTP y código de estado de la respuesta.
 */
@Component
