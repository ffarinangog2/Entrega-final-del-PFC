...
public class ReservaPersistenceMapper {
    public Reserva toDomain(ReservaJpaEntity e) {
        ...
        d.setId(e.getId()); d.setSolicitudId(e.getSolicitud().getId()); d.setLaboratorioId(e.getLaboratorioId());
    ...
    public void updateEntity(Reserva d, ReservaJpaEntity e) {
        e.setLaboratorioId(d.getLaboratorioId()); e.setResponsableId(d.getResponsableId()); e.setFechaReserva(d.getFechaReserva());
