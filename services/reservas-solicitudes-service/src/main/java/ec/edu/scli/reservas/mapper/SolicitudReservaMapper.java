...
public class SolicitudReservaMapper {
    ...
    public SolicitudReservaResponse toResponse(SolicitudReserva solicitud) {
        return new SolicitudReservaResponse(
                ...
                solicitud.getEstado(),
                solicitud.getPropuestaFecha(),
                solicitud.getPropuestaHoraInicio(),
                solicitud.getPropuestaHoraFin(),
                solicitud.getPropuestaLaboratorioId(),
                solicitud.getPropuestaObservacion(),
