    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/asistencias/sesiones").hasRole("DOCENTE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/asistencias/sesiones/*/uso").hasRole("DOCENTE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/asistencias/sesiones/*/participantes/*").hasRole("DOCENTE")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/asistencias/mi-horario-docente").hasRole("DOCENTE")
                        .requestMatchers(HttpMethod.POST, "/api/v1/asistencias/sesiones/*/cerrar").hasRole("DOCENTE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/asistencias/usos-piso/**").hasRole("ADMINISTRADOR_PISO")
