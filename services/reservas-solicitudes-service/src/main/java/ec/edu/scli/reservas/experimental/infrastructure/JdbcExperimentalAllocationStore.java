...
public class JdbcExperimentalAllocationStore implements ExperimentalAllocationStore {
        ...
        try {
            return transactional.execute(status -> {
                jdbc.update("""
                        ...
                        VALUES (?,?,?,?,0) ON CONFLICT DO NOTHING""", s.runId(), s.equipmentId(), s.inicio(), s.fin());
                Long version = jdbc.queryForObject("""
                        ...
                        s.runId(), s.equipmentId(), s.inicio(), s.fin());
                ...
                int changed = jdbc.update("""
                        ...
                        s.runId(), s.equipmentId(), s.inicio(), s.fin(), version);
    ...
    private boolean conflicts(SolicitudArbitraje s) {
        Long count = jdbc.queryForObject("""
                ...
                Long.class, s.runId(), s.equipmentId(), s.fin(), s.inicio());
    ...
    private void insert(SolicitudArbitraje s, String strategy, long version) {
        jdbc.update("""
                ...
                s.laboratorioId(), s.agenteId(), s.inicio(), s.fin(), version, strategy, Instant.now());
    }
