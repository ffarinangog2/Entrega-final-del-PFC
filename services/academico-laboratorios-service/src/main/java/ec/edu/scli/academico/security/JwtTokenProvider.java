...
/** Valida exclusivamente access tokens emitidos por auth-service. */
@Component
public class JwtTokenProvider {
    ...
    public JwtAuthenticationData parse(String token) {
        ...
        JwtPrincipal principal = new JwtPrincipal(
                ...
                requiredUuid(claims.get("perfilId", String.class), "perfilId"),
    ...
    private UUID requiredUuid(String value, String claimName) {
        if (value == null || value.isBlank()) {
            throw new IllegalArgumentException("El token no contiene el claim obligatorio " + claimName);
        }
