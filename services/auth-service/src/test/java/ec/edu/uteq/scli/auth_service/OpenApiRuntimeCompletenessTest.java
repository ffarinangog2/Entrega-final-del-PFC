...
@SpringBootTest(properties = {
        "spring.datasource.url=jdbc:h2:mem:auth_contract;MODE=PostgreSQL;DB_CLOSE_DELAY=-1",
...
class OpenApiRuntimeCompletenessTest {
    ...
    void contratoCoincideConMappingsProcesadosPorSpring() throws Exception {
        ...
        List<Operation> contract = RuntimeContractVerifier.openApiOperations(
                RuntimeContractVerifier.repositoryFile("docs/openapi/auth-service-openapi.json"));

        assertThat(runtime).hasSize(12);
        assertThat(contract).hasSize(12);
