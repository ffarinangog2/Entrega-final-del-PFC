...
estados QR. La última medición numérica conservada en la evidencia documental
registra 45,69\% de líneas. El SHA funcional
\texttt{e43967eda31410b7fef060cfc7903cea94efbe96} completó los jobs
...
afirmar 70\% sin consultar el artefacto JaCoCo de la ejecución.
...
\begin{table}[ht]
  ...
  \begin{tabular}{|p{3.1cm}|p{3.1cm}|p{3.2cm}|p{4.0cm}|}
    ...
    \hline
    Calidad Mobile & JUnit/Robolectric, JaCoCo y emulador & Test mobile; Test mobile instrumented & Medición documental: líneas 45,69\%; ambos jobs verdes en \texttt{e43967e}; cobertura numérica actual sujeta al artefacto JaCoCo. \\
    \hline
