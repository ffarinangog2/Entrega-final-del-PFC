...
Fuentes principales: `GatewayRoutes.java`, `CorsConfig.java`, los `SecurityConfig.java`, filtros y proveedores JWT, todos los controladores REST, `application.yml`, `.env.example`, `docker-compose.yml`, `.github/workflows/ci-cd.yml`, POM y pruebas existentes.
