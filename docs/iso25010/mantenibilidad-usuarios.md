...
y el IC95 t degeneró en `[media; media]`. Esto acredita repetición idéntica del
proceso sobre el mismo SHA; no expresa certeza universal ni independencia entre
líneas. La decisión global experimental es **NO CUMPLE únicamente por Android**.
