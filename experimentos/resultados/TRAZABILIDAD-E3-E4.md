...
|---|---|---|---|---|---|---|---|---|
| Eficiencia | PI1: p95 nominal <500 ms; p99 secundario <750 ms mediante límite superior IC95 | [`../protocolo-e4.md`](../protocolo-e4.md), eficiencia nominal | `ejecutar_iso25010.ps1`, `registrar_iso25010.py` | `raw/eficiencia_nominal_50u_5m/rep-01..10/`; evidencia seleccionada versionada | `analizar_iso25010.py` → `iso25010.csv` | p95 CUMPLE; p99 NO CUMPLE | [`RESUMEN-ISO25010-E4.md`](RESUMEN-ISO25010-E4.md), informe E4 | `a47f0441f644bea5f52944b7a11216f37b2242de` |
