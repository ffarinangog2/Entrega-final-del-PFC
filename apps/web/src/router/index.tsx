...
import { AdminUsoLaboratoriosPage } from '../features/asistencia/AdminUsoLaboratoriosPage'
  ...
  return (
    <RouteErrorBoundary><Routes>
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route element={<ProtectedRoute roles={['ADMINISTRADOR_PISO']} />}><Route path="/uso-laboratorios" element={<AdminUsoLaboratoriosPage />} /></Route>
